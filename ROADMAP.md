...
| Sessions full | `core/session/*` (40 files) | codec v2 + migration + latest pointer + usage sidecar-in-session landed (P1); catalog/discovery/replay/session commands partial; prompt history, result store, artifacts pending |
