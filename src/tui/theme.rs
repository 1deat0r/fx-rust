...
pub const DARK: Theme = Theme {
    bg: Color::Rgb { r: 15, g: 17, b: 26 },
    fg: Color::Rgb { r: 232, g: 230, b: 227 },
    dim: Color::Rgb { r: 110, g: 112, b: 120 },
    prompt: Color::Rgb { r: 86, g: 156, b: 255 },
    user: Color::Rgb { r: 161, g: 205, b: 255 },
    assistant: Color::Rgb { r: 232, g: 230, b: 227 },
    tool: Color::Rgb { r: 168, g: 185, b: 212 },
    tool_dim: Color::Rgb { r: 92, g: 104, b: 128 },
    error: Color::Rgb { r: 255, g: 92, b: 92 },
    ok: Color::Rgb { r: 106, g: 220, b: 133 },
    footer_bg: Color::Rgb { r: 32, g: 35, b: 48 },
    footer_fg: Color::Rgb { r: 142, g: 148, b: 162 },
    selection: Color::Rgb { r: 86, g: 156, b: 255 },
};

pub const LIGHT: Theme = Theme {
    bg: Color::Rgb { r: 250, g: 250, b: 252 },
    fg: Color::Rgb { r: 41, g: 42, b: 50 },
    dim: Color::Rgb { r: 140, g: 142, b: 152 },
    prompt: Color::Rgb { r: 24, g: 84, b: 200 },
    user: Color::Rgb { r: 30, g: 92, b: 180 },
    assistant: Color::Rgb { r: 41, g: 42, b: 50 },
    tool: Color::Rgb { r: 90, g: 104, b: 130 },
    tool_dim: Color::Rgb { r: 156, g: 164, b: 180 },
    error: Color::Rgb { r: 200, g: 30, b: 30 },
    ok: Color::Rgb { r: 30, g: 140, b: 70 },
    footer_bg: Color::Rgb { r: 236, g: 238, b: 244 },
    footer_fg: Color::Rgb { r: 96, g: 104, b: 122 },
    selection: Color::Rgb { r: 200, g: 218, b: 250 },
};

/// Resolve the requested theme mode from `FX_TUI_THEME` (or the config value
/// the caller passed in). Safe default is dark; the probe that would detect
/// light terminals automatically is deliberately not enabled by default
/// because reading the OSC reply from stdin can race the TUI's key reader.
...
fn extract_rgb_reply(reply: &str) -> Option<(u8, u8, u8)> {
    ...
    let r = parts.next()?;
    let g = parts.next()?;
    let b = parts.next()?.split(|c: char| !c.is_ascii_hexdigit()).next()?;
    Some((
        hex_tail(r)?,
        hex_tail(g)?,
        hex_tail(b)?,
...
fn hex_tail(s: &str) -> Option<u8> {
    ...
    let last2: String = trimmed.chars().rev().take(2).collect::<Vec<_>>().iter().rev().collect();
